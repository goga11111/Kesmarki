...
-------------------------------------------------- Refueling -----------------------------------------
--select * from dbo.Refueling
--truncate table dbo.Refueling
--delete from dbo.Refueling
...
/*
select * from dbo.Person --21-40
select * from dbo.Vehicle --21-40
select * from dbo.HasLicense --31-50
select * from dbo.Refueling 101-200
*/
/*
ALTER TABLE Vehicle
